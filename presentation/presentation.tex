...
The purpose of the \textbf{optimization algorithm} is to find the \texit{optimal budget} for each campaign in order to maximize the \texit{profit}, which is defined as the difference between the profits gained from selling products and the advertisement expenses.
